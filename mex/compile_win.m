...
% set the values
opts.opencv_include_path    =   'C:\opencv245\opencv\build\include'; % OpenCV include path
opts.opencv_lib_path        =   'C:\opencv245\opencv\build\x64\vc10\lib'; % OpenCV lib path
